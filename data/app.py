...
def main():
    ...
    questions = [
        # "Based on the following Safety Data Sheet, what is the emergency telephone number for the product?",
        # "What is the emergency telephone number for the product?",
        # "Based on the following Safety Data Sheet, What are the first aid measures in case of ingestion?",
